...
import com.coord.jam.XmlParser;
...
public class CollectionController {
  ...
  public ModelAndView goCollectionTestPage(
      ...
      @RequestParam(value = "brandName", defaultValue = "Chanel") String brandName,
      @RequestParam(value = "season", defaultValue = "FW") String season,
