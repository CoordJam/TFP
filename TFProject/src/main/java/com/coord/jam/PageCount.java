...
public class PageCount {
  ...
  public String ShowPaging(int pagelink, String pagename, String OtherParam,
      String... ButtonImage) {
    ...
    {
      if (pagelink > link)
        CurPage = (int) (pagelink / link) * link + 1;
      else
        CurPage = 1;
    } else
      CurPage = pagelink - (link - 1);
    int bPage = CurPage - 1;
    sb.append(
        "<table><tr><td><table width='100%' border='0' cellpadding='0' cellspacing='0' align='center' ><tr>");
    if (totalpage > limit) {
